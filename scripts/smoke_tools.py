...
call("potomac_strategies", state=True)
call("tactical_signal", name="smoke potomac", kind="potomac", strategy="Bull Bear", beta_max=1.5)
...
call("research_store")
call("research_single_window", start_year=2016, horizon_years=3, account_size=300000, basket_size=100, trigger=0.0025, approach="pairs_sector")
call("research_results", section="list")
