...
rs = win.screens["TLH research"]
pump(1)
print("research store:", rs.store_lbl.text()[:80], "| studies:", rs.study_combo.count(), "| tabs:", [rs.tabs.tabText(i) for i in range(rs.tabs.count())])
rs._estimate()
print("research estimate:", rs.est_lbl.text()[:120])
